  ...
  return (
    <Box mt='39px'  ml='367px' mr='267px' maxW='1024px'>
      <HStack h="48px" spacing='20px' >
        ...
        <Image boxSize="22px" mr='24px'  objectFit="cover" src={img2} alt="Dan Abramov" />
        <Text>No setup fees 100% hassle-free</Text>
        </HStack>
        <HStack w='230px' h='48px' mr='40px'>
        <Image boxSize="22px" objectFit="cover" mr='24px'  src={img3} alt="Dan Abramov" />
